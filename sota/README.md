...
CASEOPS_ENABLED=1 \
ITERATIONS=20000 MAX_WALLCLOCK_SECONDS=2400 \
...
GRAD_CLIP_NORM=0.3 TTT_CHUNK_SIZE=48 MUON_BACKEND_STEPS=5 \
...
SEED=42 USE_MUDD=1 KEEP_UNET=0 NUM_KV_HEADS=8 MLP_MULT=3.5 TRAIN_LOG_EVERY=1 \
RUN_ID=baseline0427_2gpu_mudd_parallel0 WARMUP_STEPS=150 PARALLEL_START_LAYER=-1 \
