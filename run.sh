...
SEED=1337 \
RUN_ID=mudd_multiway_q2k1_scale0p1_reproduce TRAIN_LOG_EVERY=1 VAL_LOSS_EVERY=500 USE_MUDD=1 MULTIWAY=1 \
MUDD_Q_DILATION=2 MUDD_K_DILATION=1 GRAD_CLIP_NORM=0.3 LN_SCALE=1 PROFILE=0 \
torchrun --standalone --nproc_per_node=2 train_gpt_mqy.py
